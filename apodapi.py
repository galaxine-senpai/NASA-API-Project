...
def get_specific_apod(month, day, year): #Month can be two or one didget (eg: 1 or 01, YEAR HAS TO BE 4)
...
if sys.argv[1] == "today":
    ...
    #print(sys.argv)
        ...
        #print("Error, date must be after June 16, 1995")
    #else:
        print(get_specific_apod(sys.argv[2], sys.argv[3], sys.argv[4]))
else:
